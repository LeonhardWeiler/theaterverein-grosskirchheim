...
function getLatestCoverSrc() {
  ...
  return `/assets/images/${latestItem["media-folder"]}/cover/0001-big.webp`;
}
  ...
  return (
    <>
      <section className="hero full-width no-top-margin">
        ...
        <img src="/assets/images/2024-doener-durst-und-dosenwurst/images/0008-big.webp" alt="Aktuelle Vorstellung" className="hero-img" />
      ...
      <section id="about-us" className="about-us">
        ...
        <img loading="lazy" src="/assets/images/2023-schmuckeralm/images/0025-big.webp" alt="Über uns" className="about-us-img" />
      </section>
